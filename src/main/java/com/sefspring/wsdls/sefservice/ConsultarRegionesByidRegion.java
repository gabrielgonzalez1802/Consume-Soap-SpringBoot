...
/**
 * <p>Clase Java para consultarRegionesByidRegion complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consultarRegionesByidRegion"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "consultarRegionesByidRegion", propOrder = {
    "idRegion"
})
public class ConsultarRegionesByidRegion {
