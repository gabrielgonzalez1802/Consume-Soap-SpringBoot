...
/**
 * <p>Clase Java para findParametroByLogin complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="findParametroByLogin"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "findParametroByLogin", propOrder = {
    "parametrosDTO"
})
public class FindParametroByLogin {
